...
Polymer({
  ...
  attached : function() {
    ...
    this.listen(window.top, "app-local-storage-changed",
                "__onAppLocalStorageChanged");
  },

  detached : function() {
    this.unlisten(window, "storage", "__onStorage");
    this.unlisten(window.top, "app-local-storage-changed",
                  "__onAppLocalStorageChanged");
  },
  ...
  __storageSourceChanged : function(storage,
                                    key) { this._initializeStoredValue(); },
  ...
  __onStorage : function(event) {
    ...
    this.syncToMemory(
        function() { this.set("data", this.__parseValueFromStorage()); });
  },
  ...
  __onAppLocalStorageChanged : function(event) {
    ...
    this.syncToMemory(function() { this.set("data", event.detail.data); });
  },
