...
function D(a) {
  var b = k(document, "link[rel=import]:not([import-dependency])"),
      c = b.length;
  c ? g(b, function(b) { return t(b, function() { 0 === --c && a(); }); })
    : a();
}
function z(a) {
  function b() {
    "loading" !== document.readyState && document.body &&
...
function A(a) {
  z(function() { return D(function() { return a && a(); }); });
}
function t(a, b) {
  if (a.__loaded)
    b && b();
...
function r(a) {
  return (a.nodeType === Node.ELEMENT_NODE && "link" === a.localName &&
          "import" === a.rel);
}
function h() {
  var a = this;
  this.a = {};
  this.b = 0;
  this.g = new MutationObserver(function(b) { return a.w(b); });
  ...
  g(k(a, "template"), function(a) {
    g(k(a.content,
      ...
      function(a) {
        ...
        g(a.attributes,
          function(a) { return b.setAttribute(a.name, a.value); });
...
function k(a, b) { return a.childNodes.length ? a.querySelectorAll(b) : E; }
function g(a, b, c) {
  var d = a ? a.length : 0, f = c ? -1 : 1;
  for (c = c ? d - 1 : 0; c < d && 0 <= c; c += f)
    b(a[c], c);
}
var n = document.createElement("link"), u = "import" in n,
    E = n.querySelectorAll("*"), w = null;
!1 === "currentScript" in document &&
    Object.defineProperty(document, "currentScript", {
      get : function() {
        return (w || ("complete" !== document.readyState
                          ? document.scripts[document.scripts.length - 1]
                          : null));
      },
      configurable : !0,
    });
var F = /(url\()([^)]*)(\))/g, G = /(@import[\s]+(?!url\())([^;]*)(;)/g,
    H = /(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g, e = {
      u : function(a, b) {
      ...
      c : function(a, b) {
        ...
        c || ((c = document.implementation.createHTMLDocument("temp")),
              (e.s = c), (c.i = c.createElement("base")),
              c.head.appendChild(c.i), (c.h = c.createElement("a")));
        c.i.href = b;
        c.h.href = a;
        return c.h.href || a;
      },
    ...
    v = /Trident/.test(navigator.userAgent) ||
        /Edge\/\d./i.test(navigator.userAgent);
h.prototype.loadImports = function(a) {
  var b = this;
  g(k(a, "link[rel=import]"), function(a) { return b.l(a); });
};
...
h.prototype.A = function(a, b) {
  ...
  g(k(a,
    ...
    function(a) {
      ...
      "script" === a.localName && !a.src && a.textContent &&
          (a.setAttribute(
    ...
    var b = !1, c = !1, d = function() {
      c && b &&
          (a.loadImports(document),
           a.b || (a.g.observe(document.head, {childList : !0, subtree : !0}),
                   a.v()));
    };
    this.C(function() {
      c = !0;
...
h.prototype.flatten = function(a) {
  ...
  g(k(a, "link[rel=import]"), function(a) {
    var c = b.a[a.href];
    (a.__import = c) && c.nodeType === Node.DOCUMENT_FRAGMENT_NODE &&
        ((b.a[a.href] = a), (a.readyState = "loading"), (a.__import = a),
         b.flatten(c), a.appendChild(c));
  });
};
h.prototype.B = function(a) {
  function b(f) {
    if (f < d) {
      var l = c[f], e = document.createElement("script");
      l.removeAttribute("import-dependency");
      g(l.attributes, function(a) { return e.setAttribute(a.name, a.value); });
      w = e;
  ...
  var c = k(document, "script[import-dependency]"), d = c.length;
  b(0);
};
h.prototype.C = function(a) {
  var b = k(document,
      ...
      c = b.length;
  if (c) {
    var d = v && !!document.querySelector(
...
h.prototype.v = function() {
  var a = this;
  g(k(document, "link[rel=import]"), function(b) { return a.j(b); }, !0);
};
h.prototype.j = function(a) {
  a.__loaded ||
      ((a.__loaded = !0), a.import && (a.import.readyState = "complete"),
       a.dispatchEvent(y(a.import ? "load" : "error", {
         bubbles : !1,
         cancelable : !1,
         detail : void 0,
       })));
...
if (u)
  ...
  Object.defineProperty(
      (!p || p.configurable ? Node : Element).prototype, "baseURI", {
        get : function() {
          var a = r(this) ? this : m(this);
          return a ? a.href
                   : p && p.get ? p.get.call(this)
  ...
  Object.defineProperty(HTMLLinkElement.prototype, "import", {
    get : function() { return this.__import || null; },
    configurable : !0,
    enumerable : !0,
  });
  z(function() { x = new h(); });
...
q.loadImports = function(a) { x && x.loadImports(a); };
