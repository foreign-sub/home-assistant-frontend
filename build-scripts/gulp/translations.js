 ...
 * Lokalise key placeholders with their target values. Under normal
 * circumstances, this will be the same as translations/en.json However, we
 * build it here to facilitate both making changes in development mode, and to
 * ensure that the project is buildable immediately after merging new
 * translation keys, since the Lokalise update to translations/en.json will not
 * happen immediately.
 */
...
gulp.task("build-merged-translations", function() {
  return gulp
      ...
      .pipe(foreach(function(stream, file) {
        ...
        //
        // TODO: This is a naive interpretation of BCP47 that should be
        // improved.
        //       Will be OK for now as long as we don't have anything more
